...
pyVersion = ("").join(list(map(str,sys.version_info[0:2])))
cyVersion = (str(pyVersion) + "x" + str(arch))

from cyCrypto.Cipher import _create_cipher
from cyCrypto.Util._raw_api import (load_pycryptodome_raw_lib,
                                  VoidPointer, SmartPointer,
                                  c_size_t, c_uint8_ptr)


_raw_cpuid_lib = load_pycryptodome_raw_lib("Crypto.Util._cpuid" + cyVersion,
