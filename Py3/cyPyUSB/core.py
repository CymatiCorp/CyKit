...
r"""cyPyUSB.core - Core USB features.
...
import cyPyUSB._lookup as _lu
import logging
import array
import threading
import functools

_logger = logging.getLogger('cyPyUSB.core')
...
def find(find_all=False, backend = None, custom_match = None, **args):
    ...
    if backend is None:
        import cyPyUSB.backend.libusb1 as libusb1
        import cyPyUSB.backend.libusb0 as libusb0
        import cyPyUSB.backend.openusb as openusb
