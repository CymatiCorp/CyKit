...
_logger = logging.getLogger('cyPyUSB.backend.openusb')
...
class _OpenUSB(cyPyUSB.backend.IBackend):
    @methodtrace(_logger)
...
#        pass
    ...
    def ctrl_transfer(self,
        ...
        direction = cyPyUSB.util.ctrl_direction(bmRequestType)
