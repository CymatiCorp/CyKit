...
r"""cyPyUSB.backend - Backend interface.
...
import cyPyUSB.backend

class MyBackend(cyPyUSB.backend.IBackend):
    pass
...
cyPyUSB.core.find() function. For example:
...
dev = cyPyUSB.core.find(backend = mybackend, idProduct=myidProduct,
                    idVendor=myidVendor)
